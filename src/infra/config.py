...
class Settings(BaseSettings):
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://linguistics:linguistics@localhost:5432/linguistics",
        description="asyncpg DSN for the linguistics cache DB.",
    )
    ...
    mistral_price_input_per_mtok: float = Field(default=0.20)
    mistral_price_output_per_mtok: float = Field(default=0.60)
